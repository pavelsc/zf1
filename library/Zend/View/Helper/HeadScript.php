 ...
 * @copyright  Copyright (c) 2005-2015 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 * @method $this appendFile($src, $type = 'text/javascript', array $attrs = [])
 * @method $this appendScript($script, $type = 'text/javascript', array $attrs = [])
 * @method $this offsetSetFile($index, $src, $type = 'text/javascript', array $attrs = [])
 * @method $this offsetSetScript($index, $script, $type = 'text/javascript', array $attrs = [])
 * @method $this prependFile($src, $type = 'text/javascript', array $attrs = [])
 * @method $this prependScript($script, $type = 'text/javascript', array $attrs = [])
 * @method $this setFile($src, $type = 'text/javascript', array $attrs = [])
 * @method $this setScript($script, $type = 'text/javascript', array $attrs = [])
 */
